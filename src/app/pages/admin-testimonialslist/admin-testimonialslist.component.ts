...
@Component({
  selector: 'app-admin-testimonialslist',
  templateUrl: './admin-testimonialslist.component.html',
  styleUrls: ['./admin-testimonialslist.component.css']
})
...
this.router.navigate(['/addtestimonials'], navigationExtras);
  }
